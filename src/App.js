      ...
      <div>
        <div>
          <Jumbotron className="jumbotron-background">          
              <h1 className="display-3">REGISTRO DE DIPLOMAS</h1>
              <p className="lead">Veja todos os diplomas dos egressos formados na Antonio Meneghetti Faculdade.</p>  
        ...
        <form>
          <FormGroup row>
            <Label for="exampleFile" xs={6} sm={4} lg={2} size="lg">Enviar</Label>          
            <Col xs={4} sm={10} lg={12}>                                                     
              <InputGroup>
                <InputGroupAddon addonType="prepend">
                  <Button color="info" style={{color: "white", zIndex: 0}} onClick={this.openFileBrowser.bind(this)}><i className="cui-file"></i> Procurar&hellip;</Button>
